...
const sizeClasses = computed(() => {
    return {
        ...
        'medium' : 'px-3 py-2.5 text-sm sm:px-5 sm:py-3 sm:text-base',
        'large'  : 'px-5 py-3 text-base sm:px-8 sm:py-3 sm:text-lg'
    }[props.size]
})
...
<template>
    <button :class="[variantClasses, sizeClasses, 'transition duration-200 rounded-xl text-white font-normal w-full']" :disabled="variant === 'loading'">
