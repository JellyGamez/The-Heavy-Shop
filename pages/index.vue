...
<template>
    <div class="bg-[url('img/texture.jpg')] bg-cover">
        <div class="bg-neutral-900 bg-opacity-90 xl:h-screen -mt-20 pt-28 px-4 md:px-10 lg:px-20 grid grid-cols-1 xl:grid-cols-2 gap-8 overflow-x-hidden">
